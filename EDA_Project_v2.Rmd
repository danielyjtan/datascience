...
ggplot(data = rw, aes(x = free.sulfur.dioxide)) +
  ...
  scale_x_log10(limits = c(NA, quantile(rw$free.sulfur.dioxide, 0.95)), 
                breaks = seq(0, quantile(rw$free.sulfur.dioxide, 0.95), 5)) +
...
```{r}
ggplot(data = rw, aes(y = total.sulfur.dioxide, 
...
ggplot(data = rw, aes(x = quality)) +
  geom_point(aes(x = rw$quality, 
                 y = rw$compounds.good, color = 'Compounds.Good'), 
             position =  'jitter', alpha = 0.5) +
  geom_point(aes(x = quality, y = rw$compounds.bad, color = 'Compounds.Bad'),
             position = 'jitter', alpha = 0.5) +
  scale_x_continuous(breaks = seq(3,8, 1)) +
  labs(title = 'Compound Type vs Wine Quality', 
